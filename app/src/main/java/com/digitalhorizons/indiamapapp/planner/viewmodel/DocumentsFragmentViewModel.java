...
public class DocumentsFragmentViewModel extends AndroidViewModel {
...
//    private AppCompatActivity mActivity;
    ...
    public DocumentsFragmentViewModel(@NonNull Application context) {
        super(context);
...
//            itemsViewHolder.getIvDocument().setImageURI(mList.get(pos).getDocumentUrl());
        ...
        getViewHolderListener = new GetViewHolderListener() {
            ...
            public View getView(int viewType, LayoutInflater layoutInflater, ViewGroup parent) {
                View view;
                view = layoutInflater.inflate(R.layout.raw_item_documents, parent, false);
                return view;
            }
